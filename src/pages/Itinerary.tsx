...
import { TripData as Trip } from "./Index";
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">{tripData.trip.location} • {tripData.trip.title}</p>
            </div>
        ...
        <Card className="mb-8 shadow-md">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-2xl">
              ...
              Trip to {tripData.trip.location}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="flex items-center gap-2">
                ...
                <span>{format(new Date(tripData.trip.start_date), "MMM d")} - {format(new Date(tripData.trip.end_date), "MMM d, yyyy")}</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4" />
                <span>{differenceInDays(new Date(tripData.trip.end_date), new Date(tripData.trip.start_date)) + 1} days</span>
              </div>
              <div>
                <span className="font-medium">Style: </span>
                <Badge variant="secondary" className="capitalize">{tripData.trip.style}</Badge>
              </div>
            </div>
            <div className="mt-4">
              <span className="font-medium">Interests: </span>
              <div className="flex flex-wrap gap-2 mt-2">
                {tripData.trip.interests.map((interest) => (
