...
export default function TripPlanner() {
  ...
  const interests = [
    ...
    "Nightlife", "Shopping", "Art", "Photography"
  ];
          ...
          <CardContent className="lg:p-8 p-4 md:p-6 space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <Label className="text-forest-primary font-semibold text-lg flex items-center gap-2">
                    <MapPinIcon className="h-5 w-5" />
                    Your Journey Route
                  </Label>
                  <p className="text-sm text-muted-foreground mt-1">Plan your route from start to destination</p>
                </div>
              </div>
              ...
              <Card className="p-6 bg-gradient-to-br from-forest-light/30 to-pink-light/20 border-forest-muted">
                <div className="space-y-4 relative">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="hidden lg:block w-4 h-4 z-10 rounded-full bg-forest-secondary flex-shrink-0 mt-1"></div>
                    <div className="flex-1 relative">
                      <Label htmlFor="startPoint" className="text-forest-primary font-semibold text-sm mb-2 block">
                        Starting Point *
                      </Label>
                  ...
                  {formData.waypoints.map((waypoint, index) => (
                    <div key={waypoint.id} className="flex items-center gap-4">
                      ...
                      <div className=" hidden lg:flex relative flex-col items-center">
                        <div className="w-3 h-3 p-2 mt-4s rounded-full z-10  bg-pink-secondary flex-shrink-0"></div>
                      </div>
                      <div className="flex-1 flex items-center gap-3">
                        <div className="flex-1">
                          <Label className="text-forest-primary font-semibold text-sm mb-2 block">
                            Stop {index + 1}
                          </Label>
                          <AddressAutocomplete
                  ...
                  <div className="flex relative  items-center gap-4">
                    <div className=" hidden relative lg:flex flex-col items-center">
                      ...
                      <Button
                        ...
                        size="sm"
                        type="button"
                        className="w-8 h-8  absolute -left-[7px] -top-[16px] hidden lg:flex rounded-full p-0 bg-pink-light hover:bg-pink-secondary hover:text-white border border-pink-secondary text-pink-secondary"
                      >
                    ...
                    <div className="flex-1">
                      <Button
                        ...
                        variant="ghost"
                        type="button"
                        className="justify-start text-pink-secondary hover:text-pink-secondary hover:bg-pink-light w-full"
                      >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="hidden lg:flex flex-col items-center">
                      <div className="w-4 h-4 rounded-full z-10 bg-forest-primary flex-shrink-0"></div>
                    </div>
                    <div className="flex-1">
                      <Label htmlFor="destination" className="text-forest-primary font-semibold text-sm mb-2 block">
                        Destination *
                      </Label>
                          <div className="relative">
                        <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label className="text-forest-primary font-semibold">Start Date *</Label>
                <Popover>
              ...
              <div className="space-y-2">
                <Label className="text-forest-primary font-semibold">End Date *</Label>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="travelers" className="text-forest-primary font-semibold flex items-center gap-2">
              ...
              <div className="space-y-2">
                <Label className="text-forest-primary font-semibold">Travel Style *</Label>
            ...
            {/* Special Interests */}
            <div className="space-y-4">
              <Label className="text-forest-primary font-semibold text-lg">Special Interests</Label>
                ...
                {interests.map(interest => (
                  <div key={interest} className="flex cursor-pointer items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-white data-[state=checked]:bg-forest-secondary"
                    />
                    <Label
                      htmlFor={interest}
